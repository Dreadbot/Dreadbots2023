...
public class RobotContainer {
  ...
  private final DreadbotMotor frontRightMotor = new DreadbotMotor(new CANSparkMax(2, MotorType.kBrushless), "frontRight");
  private final DreadbotMotor backLeftMotor = new DreadbotMotor(new CANSparkMax(3, MotorType.kBrushless), "backLeft");
  private final DreadbotMotor backRightMotor = new DreadbotMotor(new CANSparkMax(4, MotorType.kBrushless), "backRight");
